 ...
 * @author PC
 */
public class ThongKeXNVDAO {

    public List<ThongKeXeNV> getXeNhapVao() {
        String sql = "{call Sp_ThongKeXeNhapVao}";
        return select(sql);
    }

    public List<ThongKeXeNV> Select(String maCH) {
        String sql = "{call Sp_ThongKeXeNV(?)}";
        return select(sql, maCH);
    }

    public List<ThongKeXeNV> SelectThang(String month) {
        String sql = "{call Sp_ThongKeXeNVTheoThang(?)}";
